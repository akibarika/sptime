...
class ashu_meta_box{
	...
	function add_script_and_styles(){
		...
		{	
			//注意加载的脚本的url
			wp_enqueue_style('metabox_fields_css',get_template_directory_uri() . '/inc/metabox_fields.css');
			wp_enqueue_script('metabox_fields_js',get_template_directory_uri() . '/inc/metabox_fields.js');
